...
def add_config_arguments(parser=None):
    ...
    parser.add_argument('--h', type=int, default=52, help="render height for NeRF in training")
    parser.add_argument('--w', type=int, default=52, help="render width for NeRF in training")
