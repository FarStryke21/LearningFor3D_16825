...
if __name__ == "__main__":
    ...
    # Question 5.1
    print("Solution for Question 5.1 ...")
    data = load_rgbd_data()
    ...
    renderpointcloud_360(points = point1, colors = color1, filepath = "results/pointcloud1.gif", flip = True, dist = 7)
    renderpointcloud_360(points = point2, colors = color2, filepath = "results/pointcloud2.gif", flip = True, dist = 7)
    ...
    renderpointcloud_360(points = pointcloud3.points_list()[0], 
                         colors = pointcloud3.features_list()[0],
                           filepath = "results/pointcloud3.gif", flip = True, dist = 7)

    # Question 5.2
    print("Solution for Question 5.2 ...")
    points, color = generateTorus(num_samples=200)
    renderpointcloud_360(points = points, colors = color, filepath = "results/torus_parametric.gif", dist = 7)
    points, color = trefoilKnot(num_samples=200)
    renderpointcloud_360(points = points, colors = color, filepath = "results/trefoil_knot.gif", dist = 7)

    # Question 5.3
    print("Solution for Question 5.3 ...")
